...
/**
 * @author Pranav_Sharma LMU ID: 23048577 Utility class for managing HTTP
 *         sessions in a web application. Provides methods to set, get, remove
 *         session attributes and invalidate sessions.
 */
